...
model = Sequential()
model.add(GRU(units=64,  return_sequences=True, input_shape=in_dim))
model.add(GRU(units=32,  return_sequences=True, input_shape=in_dim))
model.add(GRU(units=16, input_shape=in_dim))
